...
Auto regenerate key. If true, then the keys of the managed storage account are not auto regenerated. If false, then the managed storage account's inactive key gets auto regenerated and becomes the new active key after the regeneration period.
